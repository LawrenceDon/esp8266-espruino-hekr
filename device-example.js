...
//本示例使用的产品通信协议来自 氦氪云入门教程04-基于氦氪主控协议的作品-SDK演示插座 http://bbs.hekr.me/forum.php?mod=viewthread&tid=74&fromuid=1
...
function deviceFunction() //具体的设备功能在此函数中完成
{
  ...
  }, D13, {repeat: true, edge: 'rising', debounce: 50});  
}
